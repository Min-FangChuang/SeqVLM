...
def process_scene(path, limit, frame_skip, idx):
    ...
    """if os.path.exists(output_path) and len(os.listdir(output_path)) > 0:
        print(f"Skip {idx}: output exists.")
        return"""
...
if __name__ == "__main__":
    ...
    """if os.path.exists("../data/posed_images_20frame/scans"):
        process_directory(
            "../data/posed_images_20frame/scans", args.max_images_per_scene, args.frame_skip, args.nproc
        )"""
    if os.path.exists("../data/posed_images_20frame/scans"):
        process_scene(
            "../data/posed_images_20frame/scans", args.max_images_per_scene, args.frame_skip, "scene0196_00"
        )
    # process test scenes
